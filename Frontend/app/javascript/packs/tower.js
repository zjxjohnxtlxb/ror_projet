/*
 * @Date: 2021-08-10 17:08:59
 * @LastEditors: Junxi ZHANG
 * @LastEditTime: 2021-08-10 18:46:22
 * @FilePath: /Frontend/app/javascript/packs/tower.js
 */
"use strict";
console.clear();
class Stage {
...
class Game {
    ...
    backProfil() {
        this.updateState(this.STATES.BACK);
        window.location.href='/candidat/partiel/profil?social='+ this.scoreContainer.innerHTML;
    }
    placeBlock() {
